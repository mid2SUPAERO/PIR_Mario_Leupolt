...
def getData():
    ...
    with open('C:/Users/Mario/OneDrive/Universität/Semester 8 21 SoSe/PIR/Material/Subsonic/SMT/dataSMTCm.csv', 'r') as file:
    ...
    # data from the Database:
    # Bouhlel, M. A., He, S., and Martins, J. R. R. A., “mSANN Model Benchmarks,” Mendeley Data, 2019. https://doi.org/10.17632/ngpd634smf.1
    with open ("C:/Users/Mario/OneDrive/Universität/Semester 8 21 SoSe/PIR/Material/Subsonic/SMT/DataDySMTCm.csv", "r") as file:
        reader = csv.reader(file, delimiter=";")
...
# saving the model
filename = "Subsonic/models/CmSMT.pkl"
