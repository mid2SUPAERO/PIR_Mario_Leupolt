...
def getDataset():
    ...
    with open('Subsonic/dataKerasCm.csv', 'r') as file:
...
def build_model(num_features: int, num_targets: int) -> Sequential:
    ...
    model.add(Dense(units=40, kernel_initializer=init_w, bias_initializer=init_b))
    model.add(LeakyReLU(alpha = 0.1))
...
if __name__ == "__main__":
    ...
    print(scores)
    # save model
    model.save("C:/Users/Mario/OneDrive/Universität/Semester 8 21 SoSe/PIR/Material/Subsonic/models/cm.h5")